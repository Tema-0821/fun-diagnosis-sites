...
export const metadata: Metadata = {
  title: "이용 가이드",
  description: "MBTI 궁합 계산 방식과 자주 묻는 질문을 안내합니다.",
};
...
export default function MbtiGuidePage() {
  return (
    <div className="mx-auto w-full max-w-md px-6 py-12">
      <Link href="/mbti" className="text-sm text-violet-500 hover:text-violet-600">
        ← MBTI 궁합으로 돌아가기
      </Link>
      <h1 className="font-heading-mbti mt-3 text-2xl text-violet-600">이용 가이드</h1>
