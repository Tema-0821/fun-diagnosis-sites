...
const FAQ = [
  {
    q: "결과는 어떻게 정해지나요?",
    a: "먼저 결과 이미지에 쓸 성별을 고르고, 질문 8개에 답하면 힘·지혜·기민·친화 4가지 성향 점수가 매겨져요. 가장 높은 점수가 직업을, 두 번째로 높은 점수가 종족을 결정하고, 답변 전체를 시드로 삼아 그 안에서 구체적인 종족·직업 하나를 골라 조합합니다. 100가지가 넘는 종족·직업 조합 중 하나가 나와요.",
  },
  {
    ...
    <div className="mx-auto w-full max-w-md px-6 py-12">
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-400">
          ...
          넘어요. 답변은 서버로 전송되지 않고 브라우저 안에서만 계산됩니다.
        </p>
      </section>
